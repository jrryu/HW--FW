...
NAME    
    StartHearingDSP
DESCRIPTION
    connects audio for Alango's hearing functionality with defined hearing
    parameters.
...
NAME    
    StopHearingDSP
DESCRIPTION
    disconnects audio for Alango's hearing functionality.
...
DESCRIPTION
    Changes hearing profiles for Alango's hearing functionality.
