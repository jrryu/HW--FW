...
extern const CvcPluginTaskdata alango_1mic_hearing_plugin;
extern const CvcPluginTaskdata alango_2mic_hearing_plugin;
/* internal message ids */
#define MESSAGE_FORCE_TONE_COMPLETE 	0x0001
#define MESSAGE_HEARING_CHANGE_PARAMS 	0x0002
#endif
