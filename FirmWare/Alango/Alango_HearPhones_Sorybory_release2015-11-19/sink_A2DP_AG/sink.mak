...
.PHONY : image/START.HTM \
	...
	image/usb_fat \
	image/hearing \
	image/VCP_headset/vcp_csr8670_1mic_cvsd.kap \
	image/VCP_headset_2mic/vcp_csr8670_2mic_cvsd.kap \
	image/VCP_headset_wbs/vcp_csr8670_1mic_wbs.kap \
	image/VCP_headset_2mic_wbs/vcp_csr8670_2mic_wbs.kap \
...
#  2 digital mics each side Binaural KHEP    
# image/hearing/khep_BA_digital_2MIC_16Khz.kap :
	# $(mkdir) image/hearing
	# $(copyfile) C:\ADK3.5\kalimba\apps\KHEP_rev32_16Khz\KHEP_BA_digital_2MIC\khep_BA_digital_2MIC_16Khz.kap $@

#image.fs : image/hearing/khep_BA_digital_2MIC_16Khz.kap

#  1 mic VCP CVSD
# image/VCP_headset/vcp_csr8670_1mic_cvsd.kap :
	# $(mkdir) image/VCP_headset
	# $(copyfile) C:\ADK3.5\kalimba\apps\VCP_v7.8(rev2937-2944)_NBS_WBS_1-2mic\KAP-files\CSR_8670\vcp_rev2943_csr8670_1mic_cvsd\vcp_csr8670_1mic_cvsd.kap $@

#image.fs : image/VCP_headset/vcp_csr8670_1mic_cvsd.kap

#  2 mic VCP CVSD
# image/VCP_headset_2mic/vcp_csr8670_2mic_cvsd.kap :
	# $(mkdir) image/VCP_headset_2mic
	# $(copyfile) C:\ADK3.5\kalimba\apps\VCP_v7.8(rev2937-2944)_NBS_WBS_1-2mic\KAP-files\CSR_8670\vcp_rev2943_csr8670_2mic_cvsd\vcp_csr8670_2mic_cvsd.kap $@
	
#image.fs : image/VCP_headset_2mic/vcp_csr8670_2mic_cvsd.kap

#  1 mic VCP WSB
# image/VCP_headset_wbs/vcp_csr8670_1mic_wbs.kap :
	# $(mkdir) image/VCP_headset_wbs
	# $(copyfile) C:\ADK3.5\kalimba\apps\VCP_v7.8(rev2937-2944)_NBS_WBS_1-2mic\KAP-files\CSR_8670\vcp_rev2943_csr8670_1mic_wbs\vcp_csr8670_1mic_wbs.kap $@
	
# image.fs : image/VCP_headset_wbs/vcp_csr8670_1mic_wbs.kap

#  2 mic VCP WSB
# image/VCP_headset_2mic_wbs/vcp_csr8670_2mic_wbs.kap :
	# $(mkdir) image/VCP_headset_2mic_wbs
	# $(copyfile) C:\ADK3.5\kalimba\apps\VCP_v7.8(rev2937-2944)_NBS_WBS_1-2mic\KAP-files\CSR_8670\vcp_rev2943_csr8670_2mic_wbs\vcp_csr8670_2mic_wbs.kap $@

# image.fs : image/VCP_headset_2mic_wbs/vcp_csr8670_2mic_wbs.kap
	
# #  1 mic cVc
# image/cvc_headset/cvc_headset.kap :
	# $(mkdir) image/cvc_headset
	# $(copyfile) C:\ADK3.5\kalimba\apps\cvc_headset\image\cvc_headset\cvc_headset.kap $@
...
# image/cvc_headset_2mic/cvc_headset_2mic.kap :
	...
	# $(copyfile) C:\ADK3.5\kalimba\apps\cvc_headset_2mic\image\cvc_headset_2mic\cvc_headset_2mic.kap $@
...
# image/cvc_handsfree/cvc_handsfree.kap :
	...
	# $(copyfile) C:\ADK3.5\kalimba\apps\cvc_handsfree\image\cvc_handsfree\cvc_handsfree.kap $@
...
# image/cvc_handsfree_2mic/cvc_handsfree_2mic.kap :
	...
	# $(copyfile) C:\ADK3.5\kalimba\apps\cvc_handsfree_2mic\image\cvc_handsfree_2mic\cvc_handsfree_2mic.kap $@
...
image/sbc_decoder/sbc_decoder.kap :
	...
	$(copyfile) C:\ADK3.5\kalimba\apps\a2dp_sink\image\sbc_decoder\sbc_decoder.kap $@
...
image/a2dp_low_latency_1mic/a2dp_low_latency_1mic.kap :
	...
	$(copyfile) C:\ADK3.5\kalimba\apps\a2dp_low_latency_1mic\image\a2dp_low_latency_1mic\a2dp_low_latency_1mic.kap $@
...
image/a2dp_low_latency_2mic/a2dp_low_latency_2mic.kap :
	...
	$(copyfile) C:\ADK3.5\kalimba\apps\a2dp_low_latency_2mic\image\a2dp_low_latency_2mic\a2dp_low_latency_2mic.kap $@
...
image/faststream_decoder/faststream_decoder.kap :
	...
	$(copyfile) C:\ADK3.5\kalimba\apps\a2dp_sink\image\faststream_decoder\faststream_decoder.kap $@
...
image/spdif_sink/spdif_sink.kap :
	...
	$(copyfile) C:\ADK3.5\kalimba\apps\a2dp_sink\image\spdif_sink\spdif_sink.kap $@
