...
/*!
   MESSAGE:  Hearing tells VM that the Hearing parameters were loaded
            (KALIMBA  --> VM APPLICATION)

   @brief
   Hearing sends this message after receiving CVC_LOADPARAMS_MSG to indicate if Hearing Parameters were loaded
   successfully.

   @param ParameterId(0), Flag indicating if parameters were loaded successfully.
   
*/
	HEP_PARAMS_LOADED_MSG = 0x1023
...
#define HEP_PROFILE_PS_BASE     0x225b	/* DSP_3 */
/* cVc mode values */
typedef enum
{
/*!
