...
typedef struct 
{
   /* word 8 for Hearing*/
    ...
    /* word 9 for Hearing*/
    unsigned                 volume:4;
	/*unsigned				 DSP_Max_Volume:4;
	unsigned				 DSP_Min_Volume:4;*/
    unsigned                 ActiveHearing:1;
	unsigned				 WasActive:1;
	unsigned				 unusedH1:10;
	
	/* word 10 for Hearing*/
    /*unsigned                 TimeDelayStartHearingAfterPwrOn:4;	*/
    /*unsigned                 unusedH2:12;*/
...
typedef struct
{
    /* ps configuration data for the hearing and AG functionality of Alango's HearPhones*/
    HearingParams_t	Hearing;
	/*config_ag_t		Ag;*/
} config_hearphones_t;
...
typedef struct
{
	...
	/* HearPhones dynamic configuration */
	config_hearphones_t* 	HearPhones_conf;
