...
static const ringtone_note tone_Q42[] =
{
    ...
    /*series of 1 high beeps with pause*/
static const ringtone_note tone_HearingParam1[] =
{
    RINGTONE_TEMPO(99500), RINGTONE_VOLUME(TONE_VOL), RINGTONE_TIMBRE(sine),
    ...
    /*series of 2 high beeps with pause*/
static const ringtone_note tone_HearingParam2[] =
{
    RINGTONE_TEMPO(99500), RINGTONE_VOLUME(TONE_VOL), RINGTONE_TIMBRE(sine),
    ...
    /*series of 3 high beeps with pause*/
static const ringtone_note tone_HearingParam3[] =
{
    RINGTONE_TEMPO(99500), RINGTONE_VOLUME(TONE_VOL), RINGTONE_TIMBRE(sine),
    ...
    /*series of 4 high beeps with pause*/
static const ringtone_note tone_HearingParam4[] =
{
    RINGTONE_TEMPO(99500), RINGTONE_VOLUME(TONE_VOL), RINGTONE_TIMBRE(sine),
    ...
    /*series of 5 high beeps with pause*/
static const ringtone_note tone_HearingParam5[] =
{    RINGTONE_TEMPO(99500), RINGTONE_VOLUME(TONE_VOL), RINGTONE_TIMBRE(sine),
    ...
    /*series of 6 high beeps with pause*/
static const ringtone_note tone_HearingParam6[] =
{
    RINGTONE_TEMPO(99500), RINGTONE_VOLUME(TONE_VOL), RINGTONE_TIMBRE(sine),
    ...
    /*series of 7 high beeps with pause*/
static const ringtone_note tone_HearingParam7[] =
{
    RINGTONE_TEMPO(99500), RINGTONE_VOLUME(TONE_VOL), RINGTONE_TIMBRE(sine),
    ...
    /*series of 8 high beeps with pause*/
static const ringtone_note tone_HearingParam8[] =
{
    RINGTONE_TEMPO(99500), RINGTONE_VOLUME(TONE_VOL), RINGTONE_TIMBRE(sine),
...
{
    RINGTONE_TEMPO(1000), RINGTONE_VOLUME(TONE_VOL), RINGTONE_TIMBRE(sine),
...
/*5F*/   tone_HearingParam1, /*series of 1 high beeps with pause*/
/*60*/   tone_HearingParam2, /*series of 2 high beeps with pause*/
/*61*/   tone_HearingParam3, /*series of 3 high beeps with pause*/
/*62*/   tone_HearingParam4, /*series of 4 high beeps with pause*/
/*63*/   tone_HearingParam5, /*series of 5 high beeps with pause*/
/*64*/   tone_HearingParam6, /*series of 6 high beeps with pause*/
/*65*/   tone_HearingParam7, /*series of 7 high beeps with pause*/
/*66*/   tone_HearingParam8, /*series of 8 high beeps with pause*/         
/*67*/   good_tone,          /*series of 8 high beeps with pause*/                  
