...
# Generated: Sun Nov 15 11:45:48 2015
#                                                          
...
OUTPUT=sink
OUTDIR=E:/Users/Ran Ben Ezer/Documents/CSR/VM_Projects/HearPhones_Kunyoung/sink_A2DP_AG
HARDWARE_INDEX=1
DEFS=-DENABLE_BATTERY_OPERATION -DENABLE_PSKEY_CONFIG -DDEVICE_ID_PSKEY -DBLE_DISABLED -DGATT_DISABLED -DGATT_SERVER_BAS_DISABLED -DENABLE_CAPSENSE -DENABLE_AVRCP -DINCLUDE_DSP -DINCLUDE_CVC -DTHREE_WAY_CALLING -DENABLE_GAIA -DENABLE_AGx -DDISABLE_BLE -DCONNECTION_DEBUG_LIB -DDEBUG_PRINT_ENABLEDx 
...
LIBS=-ldisplay_plugin_cns10010_scroll -ldisplay_example_plugin -ldisplay -lavrcp -lpower -lconnection_salt_no_ble -lbdaddr -lhfp_min_cfm -lregion -lservice -lcodec -lcsr_tone_plugin -laudio -lcsr_voice_prompts_plugin -lcsr_a2dp_decoder_common_plugin_stereo_bidir -la2dp -lobex -lsdp_parse -lmd5 -lusb_device_class -lspp_common -lspps -lsppc -lpblock -laudio_plugin_common -lcsr_dut_audio_plugin -lpio_common -lpbapc -lmapc -lgatt -lfm_rx_plugin -lfm_rx_api -lswat -lcsr_i2s_audio_plugin -lgaia_spp 
INPUTS=\
      sink.mak\
      Version.txt\
      audio.c\
